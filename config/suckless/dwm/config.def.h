...
/* SHCMD Commands */
static const char incvol[]    =  "wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 1%+ && kill -35 $(pidof dwmblocks)";
static const char decvol[]    =  "wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%- && kill -35 $(pidof dwmblocks)";
