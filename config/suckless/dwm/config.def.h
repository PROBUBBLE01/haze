...
static const char *fonts[]          = { "Inter:style=Semibold:size=9:antialias=true:autohint=true","SauceCodePro Nerd Font:style=Regular:size=10:antialias=true:autohint=true","Noto Color Emoji:style=Regular:pixelsize=12:antialias=true:autohint=true"};
static const char dmenufont[]       = "Inter:style=Semibold:size=9:antialias=true:autohint=true";
...
/* SHCMD Commands */
static const char incvol[]    =  "wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 3%+ && kill -35 $(pidof dwmblocks)";
static const char decvol[]    =  "wpctl set-volume @DEFAULT_AUDIO_SINK@ 3%- && kill -35 $(pidof dwmblocks)";
static const char mutevol[]   =  "wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && kill -35 $(pidof dwmblocks)";
static const char printscr[]  = "maim -s ~/media/pictures/screenshots/$(date +%s).png && notify-send -i photoqt 'Screenshot Saved'";
